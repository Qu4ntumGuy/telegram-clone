  ...
  return (
    <div className="flex w-full p-2 items-center cursor-pointer justify-between hover:bg-stone-700 hover:bg-opacity-30 rounded-lg">
      ...
      <div className="flex flex-col w-[83%]">
        ...
        <div className="text-stone-500 w-full justify-between h-10 flex">
          <div className="">
            <span>{name} joined Telegram</span>
          </div>
          <div className="bg-violet-400 text-white text-sm font-semibold text-center w-6 rounded-full p-1">
            {message}
          </div>
        </div>
      </div>
