...
function ChatPage() {
  ...
  return (
    ...
    //     <div className="flex flex-col xl:w-[58%] h-full mx-auto border border-black">
    //       <div className="flex overflow-y-scroll h-full flex-col justify-end items-center">
    ...
    <div
      className="md:flex flex-col justify-center bg-cover h-screen overflow-auto bg-black bg-opacity-100 hidden md:w-full"
      // style={{ backgroundImage: url(${backgroundImage}) }}
    >
      <div className="top-0 sticky mb-auto h-14 bg-[#202020] border-b border-[#181818]">
        <Topbar />
      ...
      <div className="flex w-full h-full overflow-hidden">
        <div className="flex flex-col xl:w-[58%] h-full mx-auto border border-black">
          <div
            className="flex overflow-y-scroll h-full flex-col justify-end items-center"
            ref={messagesContainerRef} // Added useRef for smooth scrolling
          >
            {messages.map((message) => (
              <Message
                key={message.id}
