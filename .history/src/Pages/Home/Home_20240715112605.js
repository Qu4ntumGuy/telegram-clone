...
function Home() {
  const image =
    "https://i.pinimg.com/originals/04/32/48/043248a0d66cf6b7e734597cdd7d6204.jpg";
  ...
  return (
    <div
      className="flex flex-col justify-center bg-center h-screen bg-slate-200 w-full "
